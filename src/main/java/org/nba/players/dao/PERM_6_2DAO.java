...
public class PERM_6_2DAO implements IPERM_6_2DAO {
	...
	@Override
	public void save(PERM_6_2  perm62) {
		entityManager.persist(perm62);
	}
	
	@SuppressWarnings("unchecked")
	@Override
	public List<PermModel> getAllPerm() {
		String hql = "FROM PERM_6_2";// order by if(pg=0,99,pg),if(sg=0,99,sg),if(sf=0,99,sf),if(pf=0,99,pf),if(c=0,99,c),if(ut=0,99,ut) ";
		try {
